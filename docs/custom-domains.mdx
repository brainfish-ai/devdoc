...
# Add new domain
npx @brainfish-ai/devdoc domain add new-docs.example.com
```
...
| Command | Description |
|---------|-------------|
| `npx @brainfish-ai/devdoc domain add <domain>` | Add a custom domain |
| `npx @brainfish-ai/devdoc domain status` | Check domain status |
| `npx @brainfish-ai/devdoc domain verify` | Verify DNS configuration |
| `npx @brainfish-ai/devdoc domain remove [domain]` | Remove custom domain |
