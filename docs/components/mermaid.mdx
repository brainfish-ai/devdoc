...
To create a Mermaid diagram, use the `Mermaid` component:
...
<Note>
  The diagram code should be wrapped in template literals (backticks) inside curly braces for proper parsing.
</Note>
